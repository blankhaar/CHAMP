subroutine stateq(lF1,lF2,nF1,nF2,lbd_a_r,lbd_a_i,lbd_b_r,lbd_b_i,gam_a,gam_b,wa,wb,sa,Iw,&
&Qw,Uw,Vw,delta_I,delta_Q,delta_U,delta_V,rho_a_r,rho_a_i,rho_b_r,rho_b_i)
implicit none
...
double precision rat_4_r,rat_4_i,Iw,Qw,Uw,Vw
...
do a1 = 1,lF1
  ...
  do a3 = 1,lF1
    ...
    if (a1.eq.a3) then
      call rat2_a(lF1,lF2,a1,a1,a3,Iw,Qw,Uw,Vw,delta_I,delta_Q,delta_U,delta_V,&
  &ratfaq2_r,ratfaq2_i)
  
      call rat3_a(lF1,lF2,a1,a1,a3,Iw,Qw,Uw,Vw,delta_I,delta_Q,delta_U,&
...
! real part
      if (a1.eq.a3) then
        ...
        call rat2_a(lF1,lF2,a1,a1,a4,Iw,Qw,Uw,Vw,delta_I,delta_Q,delta_U,delta_V,&
&ratfaq2_r,ratfaq2_i)

        call rat3_a(lF1,lF2,a1,a1,a4,Iw,Qw,Uw,Vw,delta_I,delta_Q,delta_U,&
&delta_V,ratfaq3_r,ratfaq3_i)
...
! now the b-part
  do b1 = 1,lF2
    ...
    call rat1_a(lF1,lF2,a1,a1,b1,b1,Iw,Qw,Uw,Vw,delta_I,delta_Q,delta_U,delta_V,ratfaq_r,&
&ratfaq_i) 
  ...
  do b1 = 1,lF2
    do b2 = b1+1,lF2 
      ...
      call rat1_a(lF1,lF2,a1,a1,b1,b2,Iw,Qw,Uw,Vw,delta_I,delta_Q,delta_U,delta_V,ratfaq1_r,&
&ratfaq1_i)

      call rat1_a(lF1,lF2,a1,a1,b2,b1,Iw,Qw,Uw,Vw,delta_I,delta_Q,delta_U,delta_V,ratfaq2_r,&
&ratfaq2_i)
...
! bra --- real part 
    do a3 = 1,lF1
      ...
      if (a1.eq.a3) then
        call rat3_a(lF1,lF2,a1,a2,a1,Iw,Qw,Uw,Vw,delta_I,delta_Q,delta_U,&
&delta_V,ratfaq_r,ratfaq_i)
      ...
      if (a2.eq.a3) then
        call rat2_a(lF1,lF2,a1,a2,a2,Iw,Qw,Uw,Vw,delta_I,delta_Q,delta_U,&
&delta_V,ratfaq_r,ratfaq_i)
...
!       real part
        if (a3.eq.a1) then
          call rat3_a(lF1,lF2,a1,a2,a4,Iw,Qw,Uw,Vw,delta_I,delta_Q,delta_U,&
&delta_V,ratfaq3_r,ratfaq3_i)       
        ...
        if (a4.eq.a1) then
          call rat3_a(lF1,lF2,a1,a2,a3,Iw,Qw,Uw,Vw,delta_I,delta_Q,delta_U,&
&delta_V,ratfaq3_r,ratfaq3_i)
        ...
        if (a2.eq.a4) then
          call rat2_a(lF1,lF2,a1,a2,a3,Iw,Qw,Uw,Vw,delta_I,delta_Q,delta_U,&
&delta_V,ratfaq2_r,ratfaq2_i)       
        ...
        if (a2.eq.a3) then
          call rat2_a(lF1,lF2,a1,a2,a4,Iw,Qw,Uw,Vw,delta_I,delta_Q,delta_U,&
&delta_V,ratfaq2_r,ratfaq2_i)       
...
!       imaginary part
    ...
    do b1 = 1,lF2
      J = J + 1
      call rat1_a(lF1,lF2,a1,a2,b1,b1,Iw,Qw,Uw,Vw,delta_I,delta_Q,delta_U,delta_V,ratfaq_r,&
  &ratfaq_i)
    ...
    do b1 = 1,lF2
      do b2 = b1+1,lF2
        ...
        call rat1_a(lF1,lF2,a1,a2,b1,b2,Iw,Qw,Uw,Vw,delta_I,delta_Q,delta_U,delta_V,ratfaq1_r,&
  &ratfaq1_i)
        call rat1_a(lF1,lF2,a1,a2,b2,b1,Iw,Qw,Uw,Vw,delta_I,delta_Q,delta_U,delta_V,ratfaq2_r,&
  &ratfaq2_i) 
...
do b1 = 1,lF2
  ...
  do a1 = 1,lF1
    ...
    call rat1_b(lF1,lF2,a1,a1,b1,b1,Iw,Qw,Uw,Vw,&
&delta_I,delta_Q,delta_U,delta_V,ratfaq_r,ratfaq_i)         
  ...
  do a1 = 1,lF1
    do a2 = a1+1,lF1
      ...
      call rat1_b(lF1,lF2,a1,a2,b1,b1,Iw,Qw,Uw,Vw,&
&delta_I,delta_Q,delta_U,delta_V,ratfaq1_r,ratfaq1_i)         
 
      call rat1_b(lF1,lF2,a2,a1,b1,b1,Iw,Qw,Uw,Vw,&
&delta_I,delta_Q,delta_U,delta_V,ratfaq2_r,ratfaq2_i)         
  ...
  do b3 = 1,lF2
    ...
    if (b3.eq.b1) then
      call rat2_b(lF1,lF2,b1,b1,b1,Iw,Qw,Uw,Vw,&
&delta_I,delta_Q,delta_U,delta_V,ratfaq2_r,ratfaq2_i) 

      call rat3_b(lF1,lF2,b1,b1,b1,Iw,Qw,Uw,Vw,&
&delta_I,delta_Q,delta_U,delta_V,ratfaq3_r,ratfaq3_i) 
  ...
  do b3 = 1,lF2
    do b4 = b3+1,lF2
      J = J + 1 
      if (b3.eq.b1) then
        call rat2_b(lF1,lF2,b1,b1,b4,Iw,Qw,Uw,Vw,&
&delta_I,delta_Q,delta_U,delta_V,ratfaq2_r,ratfaq2_i)

        call rat3_b(lF1,lF2,b1,b1,b4,Iw,Qw,Uw,Vw,&
&delta_I,delta_Q,delta_U,delta_V,ratfaq3_r,ratfaq3_i)
      ...
      if (b4.eq.b1) then
        call rat2_b(lF1,lF2,b1,b1,b3,Iw,Qw,Uw,Vw,&
&delta_I,delta_Q,delta_U,delta_V,ratfaq2_r,ratfaq2_i)

        call rat3_b(lF1,lF2,b1,b1,b3,Iw,Qw,Uw,Vw,&
&delta_I,delta_Q,delta_U,delta_V,ratfaq3_r,ratfaq3_i)
...
do b1 = 1,lF2
  do b2 = b1+1,lF2
    ...
    do a1 = 1,lF1
      ...
      call rat1_b(lF1,lF2,a1,a1,b1,b2,Iw,Qw,Uw,Vw,&
  &delta_I,delta_Q,delta_U,delta_V,ratfaq_r,ratfaq_i)         
    ...
    do a1 = 1,lF1
      do a2 = a1+1,lF1
        ...
        call rat1_b(lF1,lF2,a1,a2,b1,b2,Iw,Qw,Uw,Vw,&
  &delta_I,delta_Q,delta_U,delta_V,ratfaq1_r,ratfaq1_i)         
   
        call rat1_b(lF1,lF2,a2,a1,b1,b2,Iw,Qw,Uw,Vw,&
  &delta_I,delta_Q,delta_U,delta_V,ratfaq2_r,ratfaq2_i)         
    ...
    do b3 = 1,lF2
      ...
      if (b3.eq.b2) then
        call rat2_b(lF1,lF2,b1,b2,b2,Iw,Qw,Uw,Vw,&
  &delta_I,delta_Q,delta_U,delta_V,ratfaq2_r,ratfaq2_i) 
      ...
      if (b3.eq.b1) then
        call rat3_b(lF1,lF2,b1,b2,b1,Iw,Qw,Uw,Vw,&
  &delta_I,delta_Q,delta_U,delta_V,ratfaq3_r,ratfaq3_i) 
    ...
    do b3 = 1,lF2
      do b4 = b3+1,lF2
        J = J + 1  
        if (b3.eq.b2) then
          call rat2_b(lF1,lF2,b1,b2,b4,Iw,Qw,Uw,Vw,&
  &delta_I,delta_Q,delta_U,delta_V,ratfaq2_r,ratfaq2_i)
        ...
        if (b4.eq.b2) then
          call rat2_b(lF1,lF2,b1,b2,b3,Iw,Qw,Uw,Vw,&
  &delta_I,delta_Q,delta_U,delta_V,ratfaq2_r,ratfaq2_i)
        ...
        if (b3.eq.b1) then
          call rat3_b(lF1,lF2,b1,b2,b4,Iw,Qw,Uw,Vw,&
  &delta_I,delta_Q,delta_U,delta_V,ratfaq3_r,ratfaq3_i)
        ...
        if (b4.eq.b1) then
          call rat3_b(lF1,lF2,b1,b2,b3,Iw,Qw,Uw,Vw,&
  &delta_I,delta_Q,delta_U,delta_V,ratfaq3_r,ratfaq3_i)
...
subroutine rat1_a(lF1,lF2,a1,a2,b1,b2,Iw,Qw,Uw,Vw,delta_I,delta_Q,delta_U,delta_V,ratfaq_r,&
&ratfaq_i)
! checked 19-06-2017
! consistent with A.8
! checked numerically
...
double precision Iw,Qw,Uw,Vw,Ifp_r,Qfp_r,Ufp_r,Vfp_r
double precision x2 
double precision, dimension (lF1,3,lF1,3) :: delta_I,delta_Q,delta_U,delta_V
...
subroutine rat2_a(lF1,lF2,a1,a2,a3,Iw,Qw,Uw,Vw,delta_I,delta_Q,delta_U,delta_V,&
&ratfaq_r,ratfaq_i)
...
double precision Iw,Qw,Uw,Vw,ratfaq_r,ratfaq_i,zeta_r,zeta_i
double precision, dimension (lF1,3,lF1,3) :: delta_I,delta_Q,delta_U,delta_V
...
subroutine rat3_a(lF1,lF2,a1,a2,a3,Iw,Qw,Uw,Vw,delta_I,delta_Q,delta_U,&
&delta_V,ratfaq_r,ratfaq_i)
! we take the correct D&W 1990 formula A.39 for these
! checked 19-06-2017
! consistent with A.39
...
subroutine rat1_b(lF1,lF2,a1,a2,b1,b2,Iw,Qw,Uw,Vw,&
&delta_I,delta_Q,delta_U,delta_V,ratfaq_r,ratfaq_i)
implicit none
integer a1,a2,b1,b2,bc1,bc2,ma1,ma2,lF1,lF2,F1,F2
integer ac1,ac2,mb1,mb2
double precision ratfaq_r,ratfaq_i,zeta_r,zeta_i
double precision Iw,Qw,Uw,Vw,x2,Ifp_r,Qfp_r,Ufp_r,Vfp_r 
double precision, dimension (lF1,3,lF1,3) :: delta_I,delta_Q,delta_U,delta_V
...
subroutine rat2_b(lF1,lF2,b1,b2,b3,Iw,Qw,Uw,Vw,&
&delta_I,delta_Q,delta_U,delta_V,ratfaq_r,ratfaq_i)
implicit none
integer a1,a2,a3,b1,b2,b,mb,bc1,bc2,ma1,ma2,ma3,lF1,lF2,dm,F1,F2
integer ac1,ac2,b3,ma,mb1,mb2,mb3
double precision ratfaq_r,ratfaq_i,zeta_r,zeta_i,Iw,Qw,Uw,Vw
double precision, dimension (lF1,3,lF1,3) :: delta_I,delta_Q,delta_U,delta_V
...
subroutine rat3_b(lF1,lF2,b1,b2,b3,Iw,Qw,Uw,Vw,&
&delta_I,delta_Q,delta_U,delta_V,ratfaq_r,ratfaq_i)
implicit none
integer a1,a2,a3,b1,b2,b,mb,bc1,bc2,ma1,ma2,ma3,lF1,lF2,dm,F1,F2
integer ac1,ac2,b3,ma,mb1,mb2,mb3
