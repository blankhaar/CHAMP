subroutine stimulate(I0,Q0,V0,lF1,lF2,Aij,w0,delta_I,delta_Q,delta_U,delta_V,Rtot,Tb)
implicit none
...
do a1 = 1,lF1
  do bc1 = 1,3
    ...
    Rtot_r = Rtot_r + I0*delta_I(a1,bc1) + V0*delta_V(a1,bc1) - Q0*delta_Q(a1,bc1) 
