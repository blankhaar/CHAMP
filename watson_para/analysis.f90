...
subroutine vitals(Iw,Qw,Uw,Vw,nw,pQ,pV,pa,nimax) 
implicit none
integer n,nw,nvmax,nimax
double precision I0,Q0,U0,Vmn,Imn,Vmax,Vmin
double precision Qtot,x2,pi,Q0max,Q0min,U0max,U0min
...
!U0min = minval(Uw)
!
!if (Q0max.gt.dabs(Q0min)) then
!  Q0 = Q0max
!else
!  Q0 = Q0min
!endif
!
!if (U0max.gt.dabs(U0min)) then
!  U0 = U0max
!else
!  U0 = U0min
!endif
